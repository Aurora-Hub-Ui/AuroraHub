...
local premium_users = { "Tgpeek1", "Technique12_12", "Vbn_bountyhunter", "Waiteronewater", "iruzruz", "731niic", "RRQLEMONNl", "pedro377637", "blorospo", "flespos83", "prexos837", "polop7365", "Jaycol1", "NoSoyDekuGuys", "KandaKoe", "balle0704", "artile134", "urboyfiePoP", "Bva_Back", "Jinnxftw", "Zyxnn_18", "fanSukasusu", "tutioenRobloxgenial", "aldofp09", "sasha123jkj"}
    ...
    for obj, data in pairs(esp) do
        ...
        if obj:IsA("Model") and obj:FindFirstChild("Head") then
            ...
            if p then
                ...
                --[[elseif obj:FindFirstChild("Knife") or (b and b:FindFirstChild("Knife")) or obj:FindFirstChild("Footsteps") then
